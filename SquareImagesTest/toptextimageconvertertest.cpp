...
#include "Core/toptextimageconverter.h"
#undef protected

void TopTextImageConverterTest::convert_data()
{
    ...
    QTest::newRow("PNG Image 100x200")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-100x200.png"
            << QColor("transparent")
            << QSize(100, 220)
    ...
    QTest::newRow("PNG Image 300x300")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-300x300.png"
            << QColor("transparent")
            << QSize(300, 360)
            << MainSettingsModel::ForceNone;
    ...
    QTest::newRow("PNG Image 400x200")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-400x200.png"
            << QColor("transparent")
            << QSize(400, 280)
            << MainSettingsModel::ForceNone;
    ...
    QTest::newRow("JPG Image 100x200")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-100x200.jpg"
            << QColor("white")
            << QSize(100, 220)
            << MainSettingsModel::ForceNone;
    ...
    QTest::newRow("JPG Image 300x300")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-300x300.jpg"
            << QColor("white")
            << QSize(300, 360)
            << MainSettingsModel::ForceNone;
    ...
    QTest::newRow("JPG Image 400x200")
            ...
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-400x200.jpg"
            << QColor("white")
            << QSize(400, 280)
            << MainSettingsModel::ForceNone;
    ...
    QTest::newRow("Forced PNG Image 100x200")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-100x200.jpg"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-100x200-forced.png"
            << QColor("transparent")
            << QSize(100, 220)
    ...
    QTest::newRow("Forced PNG Image 300x300")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-300x300.jpg"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-300x300-forced.png"
            << QColor("transparent")
            << QSize(300, 360)
            << MainSettingsModel::ForcePng;
    ...
    QTest::newRow("Forced PNG Image 400x200")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-400x200.jpg"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-400x200-forced.png"
            << QColor("transparent")
            << QSize(400, 280)
            << MainSettingsModel::ForcePng;
    ...
    QTest::newRow("Forced JPG Image 100x200")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-100x200.png"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-100x200-forced.jpg"
            << QColor("white")
            << QSize(100, 220)
    ...
    QTest::newRow("Forced JPG Image 300x300")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-300x300.png"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-300x300-forced.jpg"
            << QColor("white")
            << QSize(300, 360)
            << MainSettingsModel::ForceJpg;
    ...
    QTest::newRow("Forced JPG Image 400x200")
            << "E:\\QtApps\\SquareImages\\TestData\\Input\\Text\\rect-400x200.png"
            << "E:\\QtApps\\SquareImages\\TestData\\Output\\TextTop\\rect-400x200-forced.jpg"
            << QColor("white")
            << QSize(400, 280)
            << MainSettingsModel::ForceJpg;
}

void TopTextImageConverterTest::convert() {
    ...
    TopTextImageConverter converter(conversionSettingsModel, fileSettingsModel);
